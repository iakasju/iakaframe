...
> `http://<OPENWEBUI_URL>`), et au moins une **connexion** vers un fournisseur de base models
...
iakaframe (cadrage-avant-code, états des lieux, git/votre serveur git) reste portée par le dossier `specs/`
