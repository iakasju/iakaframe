...
## Dépôt git : votre serveur git (self-hosted)
...
```powershell
pwsh <IAKAFRAME_HOME>\iakaframe-snapshot.ps1 -Reason version -Version vX.Y.Z -Note "..."
pwsh <IAKAFRAME_HOME>\iakaframe-snapshot.ps1 -Reason pause   -Note "où on s'arrête, quoi reprendre"
pwsh <IAKAFRAME_HOME>\iakaframe-snapshot.ps1 -Reason reprise -Note "reprise"
```
