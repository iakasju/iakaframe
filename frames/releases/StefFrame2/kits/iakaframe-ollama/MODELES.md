...
- **Orchestration / wiring** — déjà l'outil d'Aragorn dans iakaframe : **n8n** (ou
  **Activepieces**). Triggers, dispatch entre rôles, canal <CHAT>, enchaînement, **appels Ollama**,
...
fichiers, navigateur, sandbox/full) **et** orchestration/canal (multi-chat **<CHAT>/Telegram/
...
- Le **canal <CHAT>** d'Aragorn est nativement couvert.
