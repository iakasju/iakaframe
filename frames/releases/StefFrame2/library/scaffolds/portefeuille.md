...
entries:
  ...
  - { path: ".env", role: "token votre serveur git propagé (jamais commité)", createIfAbsent: false }
  - { path: "<charte-defaut>-dashboard/", role: "dashboard portefeuille (scan.ps1 -> data/projects.js)", createIfAbsent: false }
---
