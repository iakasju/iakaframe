...
//
// SOURCE DE VERITE = le vocabulaire canonique du coeur. Ce fichier en tient un
// miroir *sans import* : le CLI iakaframe reste **zero dependance runtime**, cross-OS,
// publiable. La parite miroir<->coeur est verifiee par un test de parite dedie (empeche la
// re-divergence que l'audit a constatee : CLI ps/iakaide/aider vs Cockpit claude-code/...).
//
// ATTENTION : ne PAS editer une valeur ici sans mettre a jour le vocabulaire canonique du coeur (le test de
