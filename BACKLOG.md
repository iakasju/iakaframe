...
### Soldé le 2026-09-10 (lot `feat/registre-options`, cadrage `registre-options-root-path-projet.md`) — REGISTRE-OPTIONS-ROOT-PATH-PROJET livré, gate PASS sans écart

- [x] **Gate 🏹 Legolas PASS sans écart** (`6442255`, `docs/qualite/gate-registre-options.md`) ; fusionné sur `main`
  (`28ccd7f`, `--no-ff`), checkpoint `ba336ee`, poussé github + origin. Suite rejouée en arbre racine après fusion :
  **1287 tests, 1286 pass, 0 fail, 1 skipped** (les 6 skips du worktree étaient bien le dépôt frère absent, nommés
  un par un par le gate). Verdicts AR-R1..R4 tous (a), « comme reco » sous autonomie max.
...
**Remise ⚒️ Gimli** (soldée par le gate ci-dessus) :
