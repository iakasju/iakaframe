...
> du déploiement `fullteam`) — cf. `library/personas/odin.md`. Les sept autres personas
> sont les agents projet dispatchables ; `coordinator: aragorn` reste le coordinateur
> d'équipe.
