...
La version scellée courante est **[v0.41.0](https://github.com/iakasju/iakaframe/releases/tag/v0.41.0)** — voir
...
Un seul fichier à télécharger sur la [page de la release](https://github.com/iakasju/iakaframe/releases/tag/v0.41.0) :

| Fichier | Commande |
|---|---|
| `naonedge-iakaframe-0.41.0.tgz` | `npm install -g naonedge-iakaframe-0.41.0.tgz` |
...
npm install -g naonedge-iakaframe-0.41.0.tgz
...
```bash
git clone https://github.com/iakasju/iakaframe.git
cd iakaframe
npm install -g ./cli
```

Sans installation globale, la CLI s'exécute directement depuis les sources :
