...
export const VERBES = [
  ...
  },
  {
    ...
    options: ['--path <dir>', '--runner claude-code|ollama|litellm|codex', '--node <n>', '--aider-model <m>', '--root <chapeau>', '--json'],
    sousVerbes: [],
    parametres: [
  ...
  },
  {
    ...
    options: ['--path <dir>', '--project <nom>', '--runner <r>', '--do "tache"', '--root <chapeau>'],
    sousVerbes: [],
    parametres: [],
  ...
  },
  {
    ...
    options: ['--path <dir>', '--project <nom>', '--root <chapeau>', '--font <nom>'],
    sousVerbes: [],
    parametres: [],
  ...
  },
  {
    ...
    options: ['--path <dir>', '--project <nom>', '--root <chapeau>', '--n <nb commits>'],
    sousVerbes: [],
    parametres: [],
  ...
  },
  {
    ...
    options: ['--write', '--binding <id>', '--root <dir>', '--json'],
    sousVerbes: [],
    parametres: [
  ...
  },
  {
    ...
    options: ['--home <dir>', '--root <dir>', '--project <nom>', '--json'],
    sousVerbes: [
