...
| **17** | 🛑 le message **E-1**, **une seconde fois** | idem entrée **16** | l'énoncé **de l'entrée 16 elle-même** : le rattrapage y était donné **sans trace**. Vrai au 2026-08-30 ; **faux depuis M1** — et c'est le seul texte du corpus qui **s'imprime à l'opérateur** au moment où il décide | *« **MESURÉ** le 2026-09-01 *(M1, banc privé)* : cette écriture **AGIT** et **prime sur tout calcul**. Jamais rejouée sur **CE** dépôt-ci »* — **aux trois dépôts** | **CORRIGÉ** *(lot L44, 2026-09-01)* |
