...
> Genere par iakaframe-snapshot.ps1 le 2026-06-23 10:00 (motif: version).
...
| Version | v0.6.1 |
| Branche | main |
| Dernier commit | 7568f6b chore(iakaframe): update etat des lieux + commit global (manual) |
| Arbre | MODIFICATIONS NON COMMITEES |
| Fichiers (hors .git/node_modules) | 171 |
| Note | rituel identite 3.4-3.9: position pastille, chaine sans interjection, verbatim anti-ventriloquie, transverse orange, propagation kits codex/ollama, kit-claude versionne + globaux |

## Commits recents

| Hash | Date | Sujet |
|---|---|---|
| `7568f6b` | 2026-06-22 | chore(iakaframe): update etat des lieux + commit global (manual) |
| `1d3937f` | 2026-06-22 | feat(method): rituel d identite - auto-annonce durcie + restitution en relais |
| `51f952f` | 2026-06-22 | feat(skills): skill iakastart bootstrap team + convention globale |
| `feb72d0` | 2026-06-22 | docs(reprise): etat des lieux pause - fin de session titres & rituels |
