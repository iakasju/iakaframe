...
> Genere par iakaframe (CLI) le 2026-06-22 23:53 (motif: version).
...
| Version | v0.6.1 |
| Branche | main |
| Dernier commit | 51f952f feat(skills): skill iakastart bootstrap team + convention globale |
| Arbre | MODIFICATIONS NON COMMITEES |
| Fichiers (hors .git/node_modules) | 167 |
| Note | rituel identite agents : auto-annonce durcie (premiere ligne de toute reponse) + restitution en relais sous le badge de l emetteur |
